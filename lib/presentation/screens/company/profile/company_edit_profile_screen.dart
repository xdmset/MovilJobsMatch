...
// PUT /perfil_empresa/{user_id}
// Body = PerfilEmpresaCreate: nombre_comercial*, sector?, descripcion?,
//                             sitio_web?, ubicacion_sede?
...
class _CompanyEditProfileScreenState extends State<CompanyEditProfileScreen> {
  ...
  void initState() {
    ...
    // Si el sector no está en la lista, ignorarlo
    if (_sector != null && !_sectores.contains(_sector)) _sector = null;
  }
  ...
  Future<void> _guardar() async {
    ...
    final id = _userId;
    if (id == null) { _snack('Error de sesión', isError: true); return; }

    final nombre = _nombreCtrl.text.trim();
    if (nombre.isEmpty) {
      _snack('El nombre comercial es obligatorio', isError: true); return;
    }

    debugPrint('[EditCompany] Guardando perfil id=$id nombre=$nombre');
    ...
    // Si falla, el error se muestra via Consumer
  }
  ...
  Future<void> _pickFoto(ImageSource source) async {
    ...
    try {
      ...
      if (mounted) _snack('Error al subir la foto: $e', isError: true);
    } finally {
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(padding: const EdgeInsets.all(16), children: [
          ...
          // ── Logo ──────────────────────────────────────────────────────
          _seccion('Logo de la empresa', Icons.business_outlined),
          ...
          Consumer<CompanyProvider>(builder: (_, p, __) {
            ...
            return Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
                ...
                Text('Imagen cuadrada recomendada',
          ...
          TextFormField(
            ...
            decoration: _deco('Nombre comercial *', Icons.business, card),
          ...
          TextFormField(
            ...
            decoration: _deco('Descripción', Icons.description_outlined, card)
                .copyWith(
                  hintText: 'Cuéntale a los candidatos sobre tu empresa...',
          ...
          TextFormField(
            ...
            style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color),
            decoration: _deco('Sitio web', Icons.language_outlined, card)
                .copyWith(hintText: 'https://tuempresa.com'),
            validator: (v) {
          ...
          TextFormField(
            ...
            style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color),
            decoration: _deco('Ciudad / Sede', Icons.location_on_outlined, card)
                .copyWith(hintText: 'Tijuana, Baja California'),
          ),
