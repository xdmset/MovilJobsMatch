// lib/presentation/screens/company/settings/company_settings_screen.dart
...
class _CompanySettingsScreenState extends State<CompanySettingsScreen> {
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        _buildCard(card, [
          _tile(
              ...
              subtitle: 'Logo, sector, descripción y más',
          ...
          _tile(
            ...
            title: 'Plan Business',
            subtitle: auth.esPremium ? 'Business activo 🚀' : 'Plan Gratuito',
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(
                child: Text(
              'Las preferencias se guardan para cuando las notificaciones push estén habilitadas.',
        ...
        _buildCard(card, [
          _tileSwitch(
            ...
            subtitle: 'Cuando un candidato aplica a tus vacantes',
        ...
        Center(
            child: Text('JobMatch Business v1.0.0',
                style: AppTextStyles.bodySmall
  ...
  Future<void> _cambiarPassword() async {
    ...
    if (nuevo.length < 8) {
      _snack('Mínimo 8 caracteres', isError: true);
      return;
    }
    try {
      ...
      setState(() => _cambioOk = true);
      _snack('Contraseña actualizada');
      await Future.delayed(const Duration(seconds: 3));
      if (mounted) setState(() => _cambioOk = false);
    } catch (_) {
      _snack('Contraseña actual incorrecta', isError: true);
    }
  }
  ...
  Widget _tile(
          ...
          Color? color}) =>
      ListTile(
          leading: Icon(icon, color: color ?? AppColors.accentBlue),
          title: Text(title,
